...
import { DeepRequired, EntityRelationPaths, ID, Injector, LanguageCode, Product, ProductVariant, RequestContext } from '@vendure/core';
...
export interface SearchConfig {
     ...
     * ```
     */
    mapQuery?: (query: any, input: ElasticSearchInput, searchConfig: DeepRequired<SearchConfig>, channelId: ID, enabledOnly: boolean, ctx: RequestContext) => any;
    /**
     * @description
